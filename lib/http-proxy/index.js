var httpProxy = exports,
    ...
    tcp       = require('./passes/tcp-incoming');
...
function ProxyServer(options) {
  ...
  this.tcp = this.proxyTCPRequest        = createRightProxy('tcp')(options);
  ...
  this.tcpPasses = Object.keys(tcp).map(function(pass) {
    return tcp[pass];
  });
